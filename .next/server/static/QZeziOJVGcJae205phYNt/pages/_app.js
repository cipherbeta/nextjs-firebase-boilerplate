...
var FirebaseContext = external_react_default.a.createContext();
/* harmony default export */ var context = (FirebaseContext);
// EXTERNAL MODULE: external "firebase/app"
var app_ = __webpack_require__("wVQA");
var external_firebase_app_default = /*#__PURE__*/__webpack_require__.n(app_);
...
var config = {// Fill out your config here.
}; // Initialize Firebase

var firebase_Firebase = function Firebase() {
  Object(classCallCheck["a" /* default */])(this, Firebase);

  if (!external_firebase_app_default.a.apps.length) {
    external_firebase_app_default.a.initializeApp(config);
    this.auth = external_firebase_app_default.a.auth();
  } else {
    external_firebase_app_default.a.app();
    this.auth = external_firebase_app_default.a.auth();
  }
} // Add in additional methods here if you'd like.
;

/* harmony default export */ var firebase = (firebase_Firebase);
// CONCATENATED MODULE: ./firebase/index.js


/* harmony default export */ var firebase_0 = (firebase);
...
function (_App) {
  ...
  Object(createClass["a" /* default */])(MyApp, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(app["Container"], null, external_react_default.a.createElement(context.Provider, {
        value: new firebase_0()
